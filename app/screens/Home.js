...
import { Text, Image, View, StyleSheet, TextInput, TouchableOpacity, Dimensions, ImageBackground } from 'react-native';
    ...
    return (
        ...
        <ScrollView style={styles.container}>
            <ImageBackground source={require('../media/header.png')} style={styles.top}>
                <View style={styles.profile}>
                    ...
                    <View style={styles.stats}>
                        <Text style={styles.h1}>Jere Salonen</Text>
            ...
            <View style={styles.bottom}>
                <Text style={styles.slider_h1}>{lang.home_welcome_title} Jere!</Text>
                <View style={styles.welcomebox}>
                    <Text style={styles.welcome_text}>{lang.home_welcome_message}</Text>
                </View>
                <TouchableOpacity style={styles.modules}>
                    <Text style={styles.h1}>{lang.home_start_training}</Text>
                </TouchableOpacity>
